...
//	echo '<script src="'.cfg('library').'modernizr.js"></script>';
	echo '<!-- fix css bug on IE6,7 download from https://selectivizr.com/ -->'._NL.'<!--[if lt IE 9]><script src="'.cfg('library').'IE8.js"></script><![endif]-->'._NL._NL;
}
...
<?php echo eval_php(cfg('navigator'),_NL,_NL);?>
</div><!--wrapper-->
</div><!--header-wrapper-->
...
<!--[if lte IE 10]>
<div class="notify" style="margin:10px 0;">เว็บไซท์นี้ไม่สนับสนุนการใช้งานบน IE6,IE7,IE8 อีกแล้ว!!!!  คุณควรเปลี่ยนไปใช้ Firefox หรือ Google Chrome หรือ ทำการปรับปรุงรุ่นของเบราเซอร์ให้เป็นรุ่นปัจจุบันโดย<a href="https://browsehappy.com/" target="_blank">คลิกที่นี่</a> หรือ <a href="https://windows.microsoft.com/en-us/internet-explorer/download-ie" target="_blank">ดาวน์โหลด IE รุ่นล่าสุด</a></div>
<![endif]-->
...
<?php
if (cfg('firebase')) {
	echo '<script src="https://www.gstatic.com/firebasejs/3.7.4/firebase.js"></script>'._NL;
	echo '<script>
  // Initialize Firebase
...
if (cfg('social.googleplus')) echo '// Load Google+ Place this tag after the last badgev2 tag.
(function() {
